...
frequency_vector_read_final = np.load("/alina-data1/Zara/RCOMB/New_data/k_minimizer_freq_vector.npy")

print("Frequency Vector Data Reading Done with length ==>>",len(frequency_vector_read_final))
variant_orig = np.load("/alina-data1/Zara/RCOMB/New_data/k_minimizer_Int_Hosts.npy")
...
number_of_clusters = [20] #number of clusters
...
for clust_ind in range(len(number_of_clusters)):
    ...
    np.save('/alina-data1/Zara/RCOMB/Results/K-means/Kmean_NewData_Minimizer/Labels_kmeans_Minimizer.npy', kmean_clust_labels)
    ...
    np.save('/alina-data1/Zara/RCOMB/Results/K-means/Kmean_NewData_Minimizer/int_true_variants_22.npy', y)
    np.save('/alina-data1/Zara/RCOMB/Results/K-means/Kmean_NewData_Minimizer/orig_true_variants_22.npy', y_orig)
    np.save('/alina-data1/Zara/RCOMB/Results/K-means/Kmean_NewData_Minimizer/test_orig_true_variants_22.npy', y_test_orig)
